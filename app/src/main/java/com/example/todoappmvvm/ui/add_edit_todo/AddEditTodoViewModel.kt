...
class AddEditTodoViewModel @Inject constructor(
    ...
    // This is key-value object that contains state variables
    // to restore ViewModel state that will be useful for its navigation argument
    ...
    // will be executed as soon as ViewModel initialized
    init {
